...
export function NextBanner() {
  ...
  return (
    <section className="text-5xl pt-10 pb-14 font-bold px-10">
      ...
      <span className="pl-3">
          <span className="text-[#72726F] font-bold">G</span>
          <span className="text-[#CA221D] font-bold">H</span>
          <span className="text-[#72726F] font-bold">T</span>
          <span className="text-[#72726F] font-bold">-RAG</span>
        </span>
    </section>
  );
}
